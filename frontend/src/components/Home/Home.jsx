...
export default function Home() {
    const [data, setData] = useState([
        { id: "1", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1214036954-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella Parmesan · Garlic · Rosemary" },
        { id: "2", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1215178083-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella  Parmesan · Garlic · Rosemary" },
        { id: "3", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1048717514-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella  Parmesan · Garlic · Rosemary" },
        { id: "4", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1207476969-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella  Parmesan · Garlic · Rosemary" },
        { id: "5", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1207476969-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella  Parmesan · Garlic · Rosemary" },
        { id: "6", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1207476969-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella  Parmesan · Garlic · Rosemary" },
        { id: "7", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1207476969-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella  Parmesan · Garlic · Rosemary" },
        { id: "8", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1207476969-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella  Parmesan · Garlic · Rosemary" },
        { id: "9", img: "https://parkofideas.com/foodz/demo1/wp-content/uploads/2019/03/demo1-1207476969-1-238x238.jpg", name: "Pizza Bianca", description: "Garlic Flatbread with Mozzarella  Parmesan · Garlic · Rosemary" },
    ])
        ...
        <div className="container">
            <div className="row"style={{ marginTop: "0" }}>
                <div className="search_from">
                    <input className="search-input form-control mx-3" type="text" placeholder="search" />
                    <button className="submit-buttom form-control mx-3" type="submit">
            ...
            <div className="row">
                {data.map((item, index) => (
                    <div className="col-sm-3 pizza-4" key={index} >
                        ...
                        <a href="#"><img src={item.img} alt="" /></a><br />
