        ...
        <div className="grid-layout">
            {
                recipes.map((item, index) => {
                    return (
                        <div className="recipe_card" key={item.id}>
                            <div className="top">
                                <img src={`${REACT_APP_UPLOADS}/${item.image}`} alt={item.name} />
                            </div>
