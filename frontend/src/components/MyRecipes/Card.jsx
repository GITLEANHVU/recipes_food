                    ...
                    <div className="detail-product detail-product_has--link">
                        ...
                        <div className="detail-product__text">
                            ...
                            <div className="btn-group">
                                <Link to={`detail-recipe/${value.id}`} className="cta">
                                ...
                                {/* <div className="btn-show">
                                    <Link to={`detail-recipe/${value.id}`} className="btn-show--link">Xem chi tiết</Link>
                                </div> */}

                                <div className="btn-handle">
                                    <span className="icon-update">
                                        <Link to={`/au-recipe/${value.id}`} className="btn-show--link btn-update">
                                    ...
                                    <span className="icon-delete">
                                        <button onClick={e => { props.handleDelete(value.id) }} className="btn-show--link btn-delete" >
