...
const account_data = {
  ...
  password: '12345678',
  address: 'test la dia chi nha toi',
  role: 'user',
  status: '1',
  id: '5',
}
// fetchFunction(create_url, account_data);
// fetchFunction(update_url, account_data);
// fetchFunction(read_single_url, {email: 'lav@gmail.com', password: '12345678'});
